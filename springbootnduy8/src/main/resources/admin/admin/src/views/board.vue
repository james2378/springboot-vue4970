...
<div class="content box6" :style='{"alignContent":"flex-start","minHeight":"100vh","flexWrap":"wrap","background":"#180312","display":"flex","width":"100%","position":"relative","height":"auto"}'>
	...
	<div :style='{"alignContent":"flex-start","padding":"20px","margin":"0 3% 20px 1%","flexWrap":"wrap","background":"rgba(255,255,255,.1)","display":"flex","width":"26%","height":"200px"}'>
		...
		<div :style='{"width":"100%","alignItems":"center","background":"rgba(255,255,255,.1)","justifyContent":"center","display":"flex"}'>
			...
			<div :style='{"padding":"0 20px","alignItems":"center","flex":"1","justifyContent":"space-between","display":"flex"}'>
				<div :style='{"lineHeight":"32px","fontSize":"16px","color":"#fff","height":"32px"}'>番剧信息总数</div>
				<div :style='{"lineHeight":"32px","fontSize":"20px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{panjuxinxiCount}}</div>
			</div>
		</div>
	...
	<div class="tables">
		<div :style='{"margin":"0 0 20px 0","color":"#fff","textAlign":"center","background":"rgba(255,255,255,.1)","width":"100%","lineHeight":"64px","fontSize":"28px","height":"64px"}'>番剧信息</div>
        <el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"#eee","borderStyle":"solid","borderWidth":"1px 0 0 1px","background":"#fff"}'>
        </el-table>
	</div>

            <div class="echarts1">
                <div id="panjuxinxiChart1" style="width:100%;height:100%;"></div>
            </div>
            <div class="echarts2">
                <div id="panjuxinxiChart2" style="width:100%;height:100%;"></div>
            </div>
            <div class="echarts3">
                <div id="panjuxinxiChart3" style="width:100%;height:100%;"></div>
            </div>
            <div class="echarts4">
                <div id="panjuxinxiChart4" style="width:100%;height:100%;"></div>
            </div>
            <div class="echarts5">
                <div id="panjuxinxiChart5" style="width:100%;height:100%;"></div>
            </div>
            <div class="echarts6">
                <div id="panjuxinxiChart6" style="width:100%;height:100%;"></div>
            </div>
</div>
...
//统计接口6
    panjuxinxiChat6() {
      this.$nextTick(()=>{
        ...
        var panjuxinxiChart6 = echarts.init(document.getElementById("panjuxinxiChart6"),'macarons');
        this.$http({
            url: `panjuxinxi/value/biaoti/pfrs`,
            method: "get",
        }).then(({ data }) => {
            if (data && data.code === 0) {
                let res = data.data;
                ...
                // 使用刚指定的配置项和数据显示图表。
                panjuxinxiChart6.setOption(option);
				

                  //根据窗口的大小变动图表
                window.onresize = function() {
                    panjuxinxiChart6.resize();
                };
            }
        });
      })
